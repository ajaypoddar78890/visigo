...
const Navbar = () => {
  ...
  return (
    <div className="flex  w-full justify-between items-center h-20 p-4 z-10 absolute text-white">
      <div>
      ...
      " size={20}/>: <FiMenu size={25} />}
       
      </div>


        {/* mobile dropdown menu */}
      <div className= {nav ? 'absolute  text-black left-0 top-0 w-full bg-gray-100 px-4 py-3 flex flex-col' : 'absolute left-[100%]' }>
